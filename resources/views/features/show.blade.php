    ...
    <div class="container mx-auto py-6 space-y-8">
        ...
        <div class="bg-white p-6 rounded shadow">
            <div class="flex items-center justify-between">
                ...
                <div class="space-x-4">
                    <span class="bg-brand-100 text-brand-800 px-3 py-1 rounded-full text-sm font-medium">
                        Epics: {{ $counts['Epic'] ?? 0 }}
                    </span>
                    <span class="bg-red-100 text-red-800 px-3 py-1 rounded-full text-sm font-medium">
                        Bugs: {{ $counts['Bug'] ?? 0 }}
                    </span>
                    <span class="bg-blue-100 text-brand-800 px-3 py-1 rounded-full text-sm font-medium">
                        Requests: {{ $counts['Request'] ?? 0 }}
                    </span>
                    <span class="bg-gray-100 text-brand-800 px-3 py-1 rounded-full text-sm font-medium">
